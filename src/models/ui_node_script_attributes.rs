...
impl UiNodeScriptAttributes {
    pub fn new(r#async: bool, crossorigin: String, id: String, integrity: String, nonce: String, referrerpolicy: String, src: String, r#type: String) -> UiNodeScriptAttributes {
